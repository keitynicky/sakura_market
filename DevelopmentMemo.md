 ...
 * vmware playerの導入
 * centosダウンロード
 * centosの仮想マシンを作ろうとしたけれどエラー
  * http://d.hatena.ne.jp/t111/20091024
 * biosに該当するメニューがないし、手詰まりかとおもっていたけれど、上記サイトにあったツールで検証してみたら、もうすでにIntel vt-xは有効になっていた。vmwareを入れてから再起動していなかったことが原因っぽい
 ...
 * branchでのコミットはGitHubのcontributionには反映されない。ただ、マスターにマージしたらそのタイミングで反映される。